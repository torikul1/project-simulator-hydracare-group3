...
document.addEventListener("DOMContentLoaded", () => {
    ...
    // Add this function to your views/js/script.js file

function proceedToCheckout() {
    // Optional: You can add a confirmation check or submit form data here if needed
    
    // Redirects directly to checkout.php inside the public folder
