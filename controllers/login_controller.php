...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($login_successful) {
        ...
        // ==========================================================================
        // ⚠️ FIXED HERE: ROLE-BASED AUTOMATED ROUTING ENGINE
        // ==========================================================================
        if ($user['role'] === 'admin') {
            // Redirect Admins directly to the Admin Dashboard routing hub
            header("Location: ../controllers/AdminController.php?action=dashboard");
            exit();
        } elseif ($user['role'] === 'vendor') {
            // Redirect Vendors directly to the Vendor Dashboard view path
            ...
            // Default Customer profile route to the Home Catalog page
